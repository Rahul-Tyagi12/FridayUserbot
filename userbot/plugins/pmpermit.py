...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By MARK41 🇮🇳"
)
...
USER_BOT_NO_WARN = (
    "**Hello,This is MARK41(@tonyironstark) Protection Service ⚠️**\n\n"
    "**Dont ask How To Get MirrorBot Please Because I am A Kinda Busy😊.**"
